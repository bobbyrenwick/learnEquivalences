...
break;
case 20:this.$ = new App.Predicate({ terms  : $$[$0-1], symbol : $$[$0-2].substr(0, $$[$0-2].length - 1) });
break;
case 21:this.$ = [$$[$0]]; 
break;
case 22:  $$[$0-2].push($$[$0]);
