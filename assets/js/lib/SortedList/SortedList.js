var App = App || {};
/**
 * App.SortedList : constructor
 */
App.SortedList = function () {
  var arr     = null,
      options = {},
      args    = arguments;
  ...
  else if (typeof options.compare == 'string' && App.SortedList.compares[options.compare]) {
    this._compare = App.SortedList.compares[options.compare];
  }
...
/**
 * App.SortedList.create(val1, val2)
 * creates an instance
 **/
App.SortedList.create = function(val1, val2) {
  return new App.SortedList(val1, val2);
};


App.SortedList.prototype = new Array();
App.SortedList.prototype.constructor = Array.prototype.constructor;
 ...
 **/
App.SortedList.prototype.insertOne = function(val) {
 ...
 **/
App.SortedList.prototype.insert = function() {
 ...
 **/
App.SortedList.prototype.remove = function(pos) {
  this.splice(pos, 1);
  return this;
}
 ...
 **/
App.SortedList.prototype.bsearch = function(val) {
 ...
 **/
App.SortedList.prototype.key = function(val, bsResult) {
 ...
 **/
App.SortedList.prototype.keys = function(val, bsResult) {
  var ret = [];
  if (bsResult == null) bsResult = this.bsearch(val);
  var pos = bsResult;
 ...
 * @returns first index if exists, null if not
 **/
App.SortedList.prototype.unique = function(createNew) {
 ...
 * get raw array
 **/
App.SortedList.prototype.toArray = function() {
  return this.slice();
};
 ...
 **/
App.SortedList.prototype._filter = function(val, pos) {
  return true;
};
 ...
 **/
App.SortedList.prototype._compare = App.SortedList.compares["string"];
if (typeof exports == 'object' && exports === this) module.exports = App.SortedList;
